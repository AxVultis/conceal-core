...
#pragma pack(pop)
  ...
  bool init() {
    if (!common::podFromHex("63617665617420656d70746f72", m_data)) {
      return false;
    }

    if (!common::podFromHex("bbec2cacf69866a8e740380fe7b818fc78f8571221742d729d9d02d7f8989b87", m_expected_hash)) {
      return false;
    }
